# ============================================================
# boss_ui.py  –  OwO Boss Command Generator  v0.6-dev
...
def load_icon_cache(assets_dir="assets", size=22):
    """
...
def process_image(path, assets_dir="assets"):
...
def build_ui(state=None):
    ...
    tk.Label(top, text="v0.6-dev", bg=C("PANEL_2"), fg=C("MUTED"),
